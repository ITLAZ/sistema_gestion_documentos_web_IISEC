...
export class LogsController {
    ...
    try {
        ...
        return await this.logsService.getLogsByActions(['Creacion documento', 'Actualización de documento','Eliminación lógica de documento', 'Eliminación lógica documento', 'Restauración documento']);
        } else if (tipo === 'login') {
